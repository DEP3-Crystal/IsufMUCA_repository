        ...
        switch (intDecision) {
            case 1:
                while (true) {
                    ...
                    DataFromProperties.addProperty(new DigitalVideoDisc(title, category, money, MediaType.DIGITAL_VIDEO_DISK.toString(), director, length));
            ...
            case 3:
                ...
                if (orders.isEmpty())
                    ...
                    for (Order order : orders) {
                        System.out.println(order.getClientName() + " " + order.getClientSurname());
